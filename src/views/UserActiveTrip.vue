<template>
    <div class="container">
                    ...
                    <div>
                        <div class="container">
                            <div class="row px-0">
                                ...
                                <p class="p-0 m-0 mb-0"><strong>Conductor: </strong>Robert Morris</p>
                                <p class="p-0 m-0 mb-0"><strong>Vehículo: </strong>Toyota Corolla (Azul)</p>
                                <p :class="animationCounter > 43 ? 'background-unphu-blue' : ''" class="current-msg p-2 mt-3 mb-0 text-center animate__animated animate__pulse" v-if="adviceMessage">{{ adviceMessage }}</p>
        ...
        <div v-if="!readOnly" class="row">
            <div class="col-4">
                <button @click="goToMain" class="btn btn-danger mt-3 w-100">Atrás</button>
            </div>
            <div class="col-4"></div>
            <div class="col-4">
